...
public class FrontOfficeEntityRepository: IEntityRepository
{
    private readonly FrontOfficeDbContext _db;

    public FrontOfficeEntityRepository(FrontOfficeDbContext db)
    {
        _db = db;
    }
